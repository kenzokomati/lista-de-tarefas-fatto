...
class AddTaskForm(forms.ModelForm):  
  task_name = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Nome da tarefa", "class":"form-control", "autofocus":"autofocus"}), label="Tarefa")
